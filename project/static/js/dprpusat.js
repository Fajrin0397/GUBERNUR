const DEFAULT_CORD = [0.692574, 127.370179];
    ...
    socket.on('connect', function(){ 
      ...
      socket.emit('datapusat', 8)
    })

    socket.on('hasJsonpus', JsonData => {
      ...
      const ctx = document.getElementById('myChartPus').getContext('2d');
      let chartStatus = Chart.getChart("myChartPus");
            if (chartStatus != undefined) {
              chartStatus.destroy();
              }  
